...
st.markdown("###Enter the name of the stock/financial asset you would like to check the sentiment of in real time.")
keyword = st.text_input("Keyword", 'Bitcoin')
st.markdown("###Enter the number of tweets the Twitter API should extract concerning the specific keyword.")
...
if(result):
  ...
  t = Tweet(tweet_link_example).component()